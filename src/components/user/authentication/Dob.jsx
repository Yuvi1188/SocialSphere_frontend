...
import { dobVerify } from '../../../store/user-actions';
...
const Dob = () => {
    ...
    return (
        <>{loading ? <Loader /> : (<div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                <h2 className="text-2xl font-bold mb-6 text-center">Enter Your Date of Birth</h2>
