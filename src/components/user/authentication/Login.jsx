...
const Login = () => {
    ...
    return (
        <>{loading ? (<Loader />) : (<div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gray-50">
            <div className="w-full max-w-sm">
                <div className="bg-white p-10 border border-gray-300 rounded-md">
                    ...
                    <form className="space-y-3" onSubmit={handleSubmit}>
                        <input
                            ...
                            ref={emailRef}
                            className="w-full px-4 py-2 border border-gray-300 rounded-sm bg-gray-50 focus:outline-none focus:border-gray-400"
                        />
                        <input
                            type="password"
                ...
                <div className="bg-white p-4 border border-gray-300 rounded-md mt-4 text-center">
                    <p className="text-sm">
